...
<body>
                                ...
                                <form method="POST" action="proses_tambah.php" enctype="multipart/form-data">
                                    <section class="base">
                                        ...
                                        <div>
                                            ...
                                            <input type="date" name="tgl_transaksi" id="tgl_transaksi" value="<?php echo $tanggal_keluar; ?>" readonly/>
                                        </div>
                                        <div>
                                        ...
                                        <div>
                                            ...
                                            <input type="number" name="hrg_jual" id="hrg_jual" readonly required maxlength="11"/>
                                        </div>
                                        <div>
                                            <label for="total_keluar">Jumlah</label>
                                            <input type="number" onkeyup="sum()" name="total_keluar" id="total_keluar" autofocus required maxlength="4" />
                                        </div>
    ...
    <script>
        ...
        $('#cmb_barang').change(function(){
            ...
            $.post('../barangmasuk/get_data_brg.php', data, function(data){
                $('#hrg_jual').val(data);
            })
        });
    </script>
