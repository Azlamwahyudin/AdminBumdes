...
$total_keluar = $_POST['total_keluar'];
...
$sisa = $data['jml_stok'] + $total_keluar;
$query1 = mysqli_query($koneksi, "update data_brg set jml_stok='$sisa' where id_brg='$kode_barang'");

$query2 = mysqli_query($koneksi, "INSERT INTO report_klr (id_transaksi,tgl_transaksi,id_brg,barang,penerima,total_keluar,hrg_jual) 
                      VALUES ('$id_transaksi','$tgl_transaksi','$kode_barang','$nama_barang','$penerima','$total_keluar','$hrg_jual')");
